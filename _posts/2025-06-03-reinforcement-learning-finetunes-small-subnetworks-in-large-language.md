...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-03-reinforcement-learning-finetunes-small-subnetworks-in-large-language/image_008.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-03-reinforcement-learning-finetunes-small-subnetworks-in-large-language/image_009.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-03-reinforcement-learning-finetunes-small-subnetworks-in-large-language/image_011.png" class="img-fluid rounded z-depth-1" %}
...
**policy와 in-distribution된 데이터에 대한 학습은 파라미터 sparse update의 주요 원인**이다. 반면, KL regularization 및 gradient clipping은 그 영향이 제한적이다.
