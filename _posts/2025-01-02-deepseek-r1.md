...
1. Cold Start으로 데이터를 구축하면 되는데, RL 과정을 하는 이유는 **scale of data**!!

1. Cold Start는 5,000개 데이터만 있으면 되지만 **R1을 학습시키기 위해서는 600,000개가 필요함**
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-01-02-deepseek-r1/image_024.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-01-02-deepseek-r1/image_025.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-01-02-deepseek-r1/image_026.png" class="img-fluid rounded z-depth-1" %}

여기서는 기존에 사용하던 reasoning modeling을 위한 reward verifier와 llama2에서 사용한 reward model을 **동시에 같이 사용함**

{% include figure.liquid loading="eager" path="assets/img/posts/2025-01-02-deepseek-r1/image_027.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-01-02-deepseek-r1/image_028.png" class="img-fluid rounded z-depth-1" %}

800,000개의 reasoning 및 non-reasoning samples로 학습을 진행함

# Experiment

{% include figure.liquid loading="eager" path="assets/img/posts/2025-01-02-deepseek-r1/image_029.png" class="img-fluid rounded z-depth-1" %}

{% include figure.liquid loading="eager" path="assets/img/posts/2025-01-02-deepseek-r1/image_030.png" class="img-fluid rounded z-depth-1" %}

# Discussion

## Distillation vs. Reinforcement Learning

_Can the model achieve comparable performance through the large-scale RL training discussed in the paper without distillation?_

→ Qwen32B-base로 실험한 결과 Zero모델은 R1에 비해 다소 떨어진 성능을 보이고 QwQ32B와 비슷한 성능을 보여줌

{% include figure.liquid loading="eager" path="assets/img/posts/2025-01-02-deepseek-r1/image_031.png" class="img-fluid rounded z-depth-1" %}

1. powerful models을 small model로 distillation하는 것은 효과적이나, **small model이 자체적으로 large-scale RL을 진행하는 것은 computaitonal cost가 큰것에 비해 성능이 좋지 **않음

1. distillation이 effective하지만 intelleigence 넘어 도달하는 것은 아직도 **powerful base model과 larger-scale RL 알고리즘이** 필수적임
