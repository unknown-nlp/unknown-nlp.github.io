...
⇒ 이 관점에서 보면 **Equation**은 matrix-valued memory에 key와 value를 계속해서 write하는 과정이라 볼 수 있음
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-02-04-titans-learning-to-memorize-at-test-time/image_004.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-02-04-titans-learning-to-memorize-at-test-time/image_007.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-02-04-titans-learning-to-memorize-at-test-time/image_008.png" class="img-fluid rounded z-depth-1" %}

{% include figure.liquid loading="eager" path="assets/img/posts/2025-02-04-titans-learning-to-memorize-at-test-time/image_009.png" class="img-fluid rounded z-depth-1" %}
