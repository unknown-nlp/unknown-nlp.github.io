...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_009.png" class="img-fluid rounded z-depth-1" %}

GRPO의 objective function J*{GRPO}(\pi*{\theta})를 optimize함

{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_010.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_011.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_012.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_013.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_014.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_015.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_016.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_017.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_018.png" class="img-fluid rounded z-depth-1" %}
...
- \Sigma{L\_{ij}} term이 simiarlity matrix L의 ith row의 합

{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_019.png" class="img-fluid rounded z-depth-1" %}

- **Pytorch Code for DAR**

{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_020.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_021.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_022.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_023.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-06-10-dra-grpo-exploring-diversity-aware-reward-adjustment-for/image_024.png" class="img-fluid rounded z-depth-1" %}
