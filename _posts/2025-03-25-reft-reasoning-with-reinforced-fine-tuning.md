...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-03-25-reft-reasoning-with-reinforced-fine-tuning/image_010.png" class="img-fluid rounded z-depth-1" %}

- value loss: Value model의 linear 학습을 위해 쓰이는듯

### Algorithm

{% include figure.liquid loading="eager" path="assets/img/posts/2025-03-25-reft-reasoning-with-reinforced-fine-tuning/image_011.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-03-25-reft-reasoning-with-reinforced-fine-tuning/image_012.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-03-25-reft-reasoning-with-reinforced-fine-tuning/image_013.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-03-25-reft-reasoning-with-reinforced-fine-tuning/image_015.png" class="img-fluid rounded z-depth-1" %}

### Majority Voting & Reward Reranking

{% include figure.liquid loading="eager" path="assets/img/posts/2025-03-25-reft-reasoning-with-reinforced-fine-tuning/image_016.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2025-03-25-reft-reasoning-with-reinforced-fine-tuning/image_018.png" class="img-fluid rounded z-depth-1" %}
