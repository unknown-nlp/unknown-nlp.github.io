...
{% include figure.liquid loading="eager" path="assets/img/posts/2023-10-31-efficient-streaming-language-models-with-attention-sinks/image_010.png" class="img-fluid rounded z-depth-1" %}
