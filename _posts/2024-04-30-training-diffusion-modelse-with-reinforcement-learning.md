...
{% include figure.liquid loading="eager" path="assets/img/posts/2024-04-30-training-diffusion-modelse-with-reinforcement-learning/image_001.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2024-04-30-training-diffusion-modelse-with-reinforcement-learning/image_002.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2024-04-30-training-diffusion-modelse-with-reinforcement-learning/image_003.png" class="img-fluid rounded z-depth-1" %}

    - weight scheme은 위와 같이 정의

      - Z에서 바로 X를 생성하는 확률을 근사, reward로 가중치를 두고 학

{% include figure.liquid loading="eager" path="assets/img/posts/2024-04-30-training-diffusion-modelse-with-reinforcement-learning/image_004.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2024-04-30-training-diffusion-modelse-with-reinforcement-learning/image_006.png" class="img-fluid rounded z-depth-1" %}
