...
- 왜 필요하쥬?
		...
		ex) aaaa<span style='color:blue'>**b**</span>aaa<span style='color:yellow'>**b**</span><span style='color:red'>**b : **</span>더 가까운 <span style='color:yellow'>**b**</span> 토큰에 높은 attn이 부여되어야 하지만, PE가 없다면, 더 먼 <span style='color:blue'>**b**</span>와 동일한 attn이 부여되게 됨.
...
## 2<span style='color:green_background'>. Motivation</span>

### Problem Definition

sequence: yyyy<span style='color:red'>**x**</span>yy<span style='color:red'>**y**</span> → x

- 마지막 시점에서 query에 대해 두 토큰 <span style='color:red'>**x**</span>와 <span style='color:red'>**y**</span>에 대한 token의 attention 관계

	- 마지막 시점에서 query와 두 토큰 <span style='color:red'>**x**</span>(i번째 이전 시점)와 <span style='color:red'>**y**</span>(j번째 이전 시점)의 positional encoding의 attention 관계

	- query에 대해서 <span style='color:red'>**x**</span>와 <span style='color:red'>**y**</span>가 가지는 attention의 비

	- 현재 시점과의 self attn과 이전 i번째 시점과의 attn 차이의 minimum bound

	- 마지막 시점의 <span style='color:red'>**y**</span>과 <span style='color:red'>**x**</span> 토큰의 attention 값의 차이 (position과 token 모두 고려시)
...
- 명령 종류
	...
	- example: <span style='color:red'>`**w0**`</span>`i1`<span style='color:blue'>`**r0**`</span><span style='color:red'>`**w0**`</span>`i0i1i1`<span style='color:blue'>`**r**`</span>` `→ 0
...
- example: D<span style='color:red'>**BB**</span>CF<span style='color:red'>**B**</span>F<span style='color:red'>**B**</span>E → DCFFE

- ID: 256 <span style='color:red'>**B **</span>토큰 포함

- Dense OOD: 128 <span style='color:red'>**B **</span>토큰 포함

- Sparse OOD: 512 <span style='color:red'>**B **</span>토큰 포함
